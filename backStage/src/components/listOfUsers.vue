<template>
  <el-main>
    ...
    <el-dialog v-model="dialogVisible" title="用户编辑" width="45%" draggable>
      <template #footer>
        <el-form :model="form" label-width="70px">
          <el-row>
            <el-col :xs="5" :sm="7" :md="9" :lg="10" :xl="12">
              ...
              <el-row justify="center" style="margin-top:17px">
            ...
            <el-col :xs="7" :sm="10" :md="11" :lg="12" :xl="15">
...
const handleBefore = (file) => {
  ...
  return new Promise((resolve, reject) => {
    const isType = /\.(image|jpeg)/.test(file.type);
...
function UploadCheck(body: { fileName: any; size: any; }) {
