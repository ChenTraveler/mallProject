<template>
  <div class="bigFather">
    <div class="head">
      <h2>商品分类</h2>
      <el-button text @click="form.dialogFormVisible = true" class="btn1">
        添加分类
      </el-button>
    </div>
    <el-table :data="tableData.data" max-height="620" class="d1" style="width: 100%; margin-bottom: 20px"
      row-key="value" border>
      <el-table-column prop="label" label="分类名称" align="center" />
      <el-table-column prop="flag" label="是否上市" align="center">
      </el-table-column>
    ...
    <!-- 添加商品的弹窗 -->
    <el-dialog v-model="form.dialogFormVisible" title="请选择你要添加的数据">
      <el-form>
        ...
        <el-form-item label="请输入添加的层级">
          <div class="example-block">
            <el-cascader :options="tableData.data" :props="props1" placeholder="分类名称" clearable v-model="form.cj">
    ...
    <!-- 编辑商品的弹窗 -->
    <el-dialog v-model="form1.dialogFormVisible" title="请选择你要修改的数据">
      <el-form>
        <el-form-item label="请输入修改的分类名称">
          <el-input autocomplete="off" v-model="form1.name" />
        </el-form-item>
