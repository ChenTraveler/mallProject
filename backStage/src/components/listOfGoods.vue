  ...
  <div class="BigFather">
    ...
    <div class="content">
      <el-table :data="ddd.tableData1.slice((fy.currentPage-1)*fy.pageSize,fy.currentPage*fy.pageSize)"
        ...
        <el-table-column prop="stime" label="提交时间" align="center" min-width="280" />
        <el-table-column prop="title" label="商品名称" align="center" min-width="180" />
        <el-table-column prop="num" label="购买数量" align="center" min-width="80" />

        <el-table-column prop="ftime" label="完成时间" align="center" min-width="180" />
        <el-table-column prop="state" label="状态" align="center" min-width="180" />
